  ...
  <script type="text/javascript" src="{{ asset('assets/js/bootstrap.min.js') }}"></script>
    ...
    <header id="header" class="header-default header-style-2">
            ...
            <div class="row wrapper-header align-items-center">
              <div class="col-xl-5 tf-md-hidden">
                <div class="tf-cur">
                  <div class="tf-currencies">
                    ...
                    >
                      <option selected data-thumbnail="{{ asset('assets/images/country/vn.svg') }}">
                        VND <span>VNĐ | Vietnam</span>
                      </option>
                      <option data-thumbnail="{{ asset('assets/images/country/us.svg') }}">
              ...
              <div class="col-xl-2 col-md-4 col-6 text-center">
                <a href="index.html" class="logo-header">
                  <img
                    src="{{ asset('assets/images/logo/logo%402x.png') }}"
                    alt="logo"
                    class="logo"
                  />
                </a>
        ...
        <div class="header-bottom line tf-md-hidden">
          <div class="container-full px_15 lg-px_40">
            <div
              class="wrapper-header d-flex justify-content-center align-items-center"
            >
                ...
                >
                  <li class="menu-item">
                    <a href="#" class="item-link"
                      >Home<i class="icon icon-arrow-down"></i
                    ></a>
                      ...
                      <div class="container">
                        ...
                        <div class="text-center view-all-demo">
                          <a
                            href="#modalDemo"
                            data-bs-toggle="modal"
                            class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"
                              ...
                              <ul class="menu-list">
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Pagination infinite scrolling</a
                                  >
                                </li>
                                <li>
                                  <a
                        ...
                        <div class="row">
                              ...
                              <ul class="menu-list">
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Product description vertical</a
                                  >
                                </li>
                              </ul>
                            </div>
                              ...
                              <ul class="menu-list">
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Product external zoom and photoswipe
                                    popup</a
                                  >
                                </li>
                                <li>
                              ...
                              <ul class="menu-list">
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Product swatch image rounded</a
                                  >
                                </li>
                                <li>
                                  <a
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Product swatch dropdown color</a
                                  >
                                </li>
                              </ul>
                            </div>
                              ...
                              <ul class="menu-list">
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Frequently bought together 2</a
                                  >
                                </li>
                                <li>
                                  <a
                                ...
                                <li>
                                  <a
                                    ...
                                    class="menu-link-text link"
                                    >Complimentary products</a
                                  >
                                </li>
                                <li>
                                  <a
                                    href="product-quick-order-list.html"
                                    class="menu-link-text link position-relative"
                                    >Quick order list
                                    <div class="demo-label">
                                      <span class="demo-new">New</span>
                                    </div></a
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="hover-sw-nav hover-sw-2">
                              <div
                                class="swiper tf-product-header wrap-sw-over"
                              >
                                  ...
                                  <div class="swiper-slide" lazy="true">
                                    <div class="card-product">
                                      <div class="card-product-wrapper">
                                        ...
                                        <div
                                          class="list-product-btn absolute-2"
                                        >
                                          <a
                                            href="#quick_add"
                                            data-bs-toggle="modal"
                                      ...
                                      <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                          ...
                                          >
                                            ...
                                            <span
                                              class="swatch-value bg_orange-3"
                                            ></span>
                                            <img
                                              class="lazyload"
                                              data-src="images/products/orange-1.jpg"
                  ...
                  <li class="menu-item position-relative">
                    <a href="#" class="item-link"
                      >Pages<i class="icon icon-arrow-down"></i
                    ></a>
                  ...
                  <li class="menu-item position-relative">
                    <a href="#" class="item-link"
                      >Blog<i class="icon icon-arrow-down"></i
                    ></a>
                    <div class="sub-menu submenu-default">
                      <ul class="menu-list">
                        <li>
