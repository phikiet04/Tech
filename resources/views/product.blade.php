                            ...
                            <div class="card-product">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        ...
                                        <img class="lazyload img-hover" data-src="{{ asset('assets/images/images/products/white-1.jpg') }}" src="{{asset('assets/images/products/white-1.jpg')}}" alt="image-product">
                                    </a>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        ...
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="images/products/white-7.jpg" src="{{asset('assets/images/products/white-7.jpg')}}" alt="{{asset('assets/image-product')}}">
                                        </li>
                                    </ul>
                                </div>
                            </div>
